...
interface LogQueryVariableState extends SceneObjectState {
    config: ConfigProps;
    type: 'textbox';
    hide?: VariableHide;
    name: string;
...
const LogQueryVariableRenderer = ({ model }: SceneComponentProps<LogQueryVariable>) => {
...
export class LogQueryVariable extends SceneObjectBase<LogQueryVariableState> implements SceneVariable<LogQueryVariableState> {
    static Component = LogQueryVariableRenderer;
    protected _urlSync = new SceneObjectUrlSyncConfig(this, { keys: () => [this.getKey()] });
    public constructor(initialState: Partial<LogQueryVariableState>) {
        super({
            ...initialState,
            type: 'textbox',
            value: '',
