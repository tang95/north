...
interface TraceQueryVariableState extends SceneObjectState {
    config: ConfigProps;
    type: 'textbox';
    hide?: VariableHide;
    name: string;
...
const TraceQueryVariableRenderer = ({ model }: SceneComponentProps<TraceQueryVariable>) => {
...
export class TraceQueryVariable extends SceneObjectBase<TraceQueryVariableState> implements SceneVariable<TraceQueryVariableState> {
    static Component = TraceQueryVariableRenderer;
    protected _urlSync = new SceneObjectUrlSyncConfig(this, { keys: () => [this.getKey()] });
    public constructor(initialState: Partial<TraceQueryVariableState>) {
        super({
            ...initialState,
            type: 'textbox',
            value: '',
